        ...
        for(Cluster cluster : getClusters()){
            ...
            if(!aggregatedQueryResult.isEmpty()){
                ...
                for (Map<String, Object> record : aggregatedQueryResult) {
                    ...
                    createAlert(queriedScript, record);
...
//                System.out.println(e);
    ...
    private void createAlert(Script queriedScript, Map<String, Object> record) {
...
//        alerts.add(alert);
        ...
        System.out.println("================= created Alert for " +alert.getAlertId()+ " ===================");
    }
